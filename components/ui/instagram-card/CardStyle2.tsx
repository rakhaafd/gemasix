...
export const CardStyle2 = forwardRef<HTMLDivElement, CardStyleProps>(
  ({ message, logoSrc }, ref) => {
    const fontSize =
      message.length <= 80
        ? "text-[68px]"
    ...
    return (
      ...
      >
        ...
        <div className="absolute bottom-14 left-1/2 -translate-x-1/2 bg-primary-900/60 rounded-full px-7 py-2.5">
          <p className="text-white text-2xl font-bold tracking-wide whitespace-nowrap">
            gemasix.my.id/ngl
          </p>
        </div>
      </div>
...
CardStyle2.displayName = "CardStyle2";
